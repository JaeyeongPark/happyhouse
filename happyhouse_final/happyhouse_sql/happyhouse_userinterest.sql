...
CREATE TABLE `userinterest` (
  ...
  CONSTRAINT `userinterest_ibfk_1` FOREIGN KEY (`id`) REFERENCES `user` (`id`),
  CONSTRAINT `userinterest_ibfk_2` FOREIGN KEY (`dongCode`) REFERENCES `baseaddress` (`dongCode`)
...
INSERT INTO `userinterest` VALUES ('굥굥님','1111010100'),('우빈님','1111010200');
